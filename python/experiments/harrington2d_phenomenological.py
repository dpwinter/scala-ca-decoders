...
def benchmark_pheno(
    ...
    *,
    ...
    if reset_time is not None and reset_time > d:
        raise ValueError("harrington2d phenomenological requires reset_time <= distance")
    ...
    if output_dir is not None:
        ...
        stem = (
            f"harrington2d_phenomenological_d{d}_pdata{p:g}_pmeas{p_meas:g}_psig{p_sig:g}"
